          ...
          >
            ...
            >
              <div className="flex flex-col gap-1.5">
                <span className="font-h2 font-light text-[28px] text-hero-name group-hover:text-white tracking-[-0.02em] leading-none transition-colors duration-300">
                  {item.name}
                </span>
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="w-1 h-1 rounded-full bg-black/20 group-hover:bg-white/30 shrink-0 transition-colors duration-300" />
